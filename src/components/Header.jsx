  ...
  return (
    ...
    <div className="relative mx-10  py-5  sm:flex-row flex flex-col justify-between items-center">
        ...
        <div className="poiret-one-regular mb-3 ">
          <Link to='/worldmap' onClick={() => handleClick('home')}> <h1 className="shadow-text-black font-extrabold text-2xl">World<span className="text-amber-500">sx</span>Map </h1>
          </Link>
        </div>
